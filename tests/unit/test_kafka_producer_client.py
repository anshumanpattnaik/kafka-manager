...
class TestKafkaProducerClient:
    ...
    def test_kafka_producer_client_start_with_kafka_error(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
        """ Test Kafka producer with kafka error """
        mock_kafka_producer.side_effect = KafkaError('Kafka Error')
        assert kafka_producer_client.start() is False

    def test_kafka_producer_client_send_message(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_send_message_when_producer_not_running(
        self, kafka_producer_client: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_send_message_when_no_value_specified(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_flush_messages(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_stop(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_stop_with_kafka_error(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_stop_already_stopped(
        self, kafka_producer_client: Mock
    ) -> None:
    ...
    def test_kafka_producer_client_checking_is_producer_running(
        self, kafka_producer_client: Mock, mock_kafka_producer: Mock
    ) -> None:
